...
colAll            = colCollaboration | colIndividual ;
...
data_trial.sub1.fsample = data_preproc.sub1.cfg.previous.fs;
data_trial.sub2.fsample = data_preproc.sub2.cfg.previous.fs;
